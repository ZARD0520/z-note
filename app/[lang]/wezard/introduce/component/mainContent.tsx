    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <InfoCard
            title={dict.zard.content.cardTitle1}
            content={dict.zard.content.cardContent1}
          />
          
          <InfoCard
            title={dict.zard.content.cardTitle2}
            content={dict.zard.content.cardContent2}
          />
          
          <InfoCard
            title={dict.zard.content.cardTitle3}
            content={dict.zard.content.cardContent3}
          />
        </div>
      </div>
    </section>
      ...
      <div className="container mx-auto px-4">
        <div className="bg-slate-500/10 border border-white/10 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-400 mb-4">{dict.zard.content.stateTitle}</h2>
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 md:p-12 max-w-4xl mx-auto text-center border border-white/10">
          <h2 className="text-3xl font-bold text-slate-400 mb-8">{dict.zard.content.legacyTitle}</h2>
