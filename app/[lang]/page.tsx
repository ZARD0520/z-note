...
export default async function Home({ params: { lang } }: DefaultPageProps) {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <Link
        href="/chat"
        className="rounded-lg w-80 pt-4 pb-4 pl-4 flex flex-row items-center border mb-8"
      >
      ...
      <Link
        href="/wezard"
        className="rounded-lg w-80 pt-4 pb-4 pl-4 flex flex-row items-center border"
      >
